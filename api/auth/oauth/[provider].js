...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // persist verifier + state for the callback to read
    ...
    // ✅ correct Stack Auth endpoint (NO /projects/<id>)
    const url = new URL('https://api.stack-auth.com/api/v1/auth/oauth/authorize');
